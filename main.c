...
//    if (HAL_GPIO_ReadPin(GPIOD, GPIO_PIN_2)) // if the pin is HIGH
//    {
//     HAL_GPIO_WritePin(GPIOD, GPIO_PIN_12, 1); // turn on LED
//    } else {
//        HAL_GPIO_WritePin(GPIOD, GPIO_PIN_12, 0); // turn off LED
//    }
//    if (HAL_GPIO_ReadPin(GPIOD, GPIO_PIN_0)) // if the pin is HIGH
//    {
//     HAL_GPIO_WritePin(GPIOD, GPIO_PIN_14, 1); // turn on LED
//    } else {
//        HAL_GPIO_WritePin(GPIOD, GPIO_PIN_14, 0); // turn off LED
//    }
...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pins : PD0 PD1 OTG_FS_OverCurrent_Pin */
  GPIO_InitStruct.Pin = GPIO_PIN_0|GPIO_PIN_1|OTG_FS_OverCurrent_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(GPIOD, &GPIO_InitStruct);

...
// The CapChartViewController is designed to display the historic metrics of the capacity
...
class CapChartViewController: UIViewController, ChartViewDelegate {
    ...
    // The following function initializes the chart allignment on the view controller.
    override func viewDidLayoutSubviews() {
        ...
        appDelegate.ref.child("HunterApt").getData(completion: { error, snapshot in
            ...
            // 'currentCapacity' and 'Time' are then the selected child node of Hunter Apt.
    ...
    // if they are not pleased with the number of people in the store.
